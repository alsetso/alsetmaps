...
export default function SellPageImproved() {
    ...
    try {
      ...
      const response = await fetch('/api/for-sale', {
        ...
        headers: { 
          ...
          'Authorization': `Bearer ${user?.id}` // Add user ID as header for debugging
        },
  ...
  const canProceedToNext = () => {
    switch (currentStep) {
      ...
      case 2:
        return form.watch('propertyType') && form.watch('listingPrice') && form.watch('timeline');
      case 3:
                  ...
                  <div className="p-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900">How Are You Selling?</h3>
                      </div>
