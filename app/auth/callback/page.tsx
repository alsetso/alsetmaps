      ...
      <div className="max-w-sm w-full space-y-6">
        ...
        {status === 'error' && (
          <div className="space-y-3">
            <button
              onClick={handleRetry}
              className="w-full bg-gray-900 text-white px-4 py-2 rounded-md font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
              Try Again
            </button>
            <button
              onClick={handleGoHome}
              className="w-full bg-white text-gray-900 px-4 py-2 rounded-md font-medium border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
              Go to Home
            </button>
          </div>
